    ...
    <div class="container mt-3 mb-5 ">
        <div class="row">
            <div class="col-sm-12 mb-3" style="font-size:large;">
                <a href="./?page=home">Trang chủ</a> <i class="fa fa-angles-right"></i> <a href="./?page=my_home">Quản lý nhà</a> <i class="fa fa-angles-right"></i> <a class="text-primary" href="javascript:void(0)">Sửa thông tin nhà</a>
            </div>
        </div>
                    ...
                    <div class="row rounded">
                        <div class="col-sm-12 border" style="width: 100%;height:auto">
                            <div class="p-4" id="add">
                                ...
                                <div class="form-group mb-3">
                                    <label for="">Địa chit cụ thể</label>
                                    <textarea name="home_address" id="home_address" class="form-control" placeholder="Địa chỉ chi tiết (Phường, đường, Số nhà...)" rows="3"><?php echo $row_ed['DiaChi']; ?></textarea>
                                    <span class="text-danger" id="home_address_err"></span>
                                </div>
                                <div class="form-group mb-3 ">
                                ...
                                <div class="text-end">
                                    ...
                                    <input class="btn btn-success" style="width: 100px;" type="submit" class="btn btn-success" name="edit_home" id="edit_home" value="Lưu">
                                </div>
                            </div>
                        </div>
                    </div>
