...
<div class="card p-3" style="margin-bottom: 30px;">
    <div class="col-sm-12">
        <img style="position: center;" class="border rounded p-1 rounded mx-auto d-block" src="../../image/profile_image/<?php if ($row_ct['profile_img'] == "") {echo "user_profile.jpg";} else {echo $row_ct['profile_img']; }?>" alt="" width="250" id="output" style="width: 150px; height: 150px; margin-top: 5px;" />
        <div class="row" style="margin-top: 20px;">
            <div class="col-sm-6">
                <div class="row p-2">
                    <div class="col-sm-4">
                        <b for="">Mã người dùng: </b>
                    </div>
...
<div class="text-center">
    <input style="width: auto;" type="submit" class="btn btn-danger" onclick="history.back()" value="Thoát">
</div>