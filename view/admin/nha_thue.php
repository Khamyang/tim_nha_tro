...
<div class="card p-3">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="table-responsive">
            <table class="table table-borderde table-hover table-striped" style="width: 100%;" id="tb_nha_thue">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=$row->TenDN?></td>
                        <td><?=$row->TenNha?></td>
                        <td><img src="../../image/product_image/<?=($row->HinhAnh != "")?$row->HinhAnh:'user_img1.png';?>" alt="" width="100px" class="rounded"></td>
                        <td><?=$row->TenHuyen?></td>
                        <td><?=$row->TenBan?></td>
                        <td><?=$row->MoTa?></td>
                        <td><?=$row->DiaChi?></td>
                        <td>
                            ...
                            <span style="width: 100px;" class="d-flex align-center rounded p-2 alert-<?=($row->TrangThai == 1) ? 'success':'secondary'?>" id="trangthai_dk<?=$row->MaDk?>"><?=($row->TrangThai == 1) ? 'Đang trống':'Không trống'?></span>
                        </td>
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example" style="width: 70px;">
