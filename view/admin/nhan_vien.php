<div class="card p-3">
    <div class="text-end mb-2">
        ...
        <a href="<?php if ($_SESSION['maquyen'] == 2) {echo "javascript:void(0)";} else {echo "?page=them_nhan_vien";}?>" class="btn btn-<?php if ($_SESSION['maquyen'] == 2) {echo "secondary"; } else {echo "primary";}?>" id="btn_add" name="btn_add" >Thêm nhân viên</a>
    </div>
	        ...
	        <table class="table table-borderde table-hover table-striped" style="width: 100%;" id="tb_nhanvien">
	            ...
	            <tbody>
	                ...
	                <tr class="">
	                    ...
	                    <td><img src="../../image/profile_image/<?=$row->profile_img?>" alt="" style="width: 45px; height: 45px" class="rounded-circle"></td>
	                    <td><?=$row->TenDN?></td>
	                    <td><?=$row->HoTen?></td>
                        ...
                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
							<a class="btn btn-sm btn-info" id='btn_edit' href='?page=chitiet_thongtin_nguoidung' ><i class="fa fa-eye"></i></a>

	                        <a class="btn btn-sm btn-<?php if ($_SESSION['maquyen'] == 2) {echo "secondary"; } else {echo "success";}?>" id='btn_edit' href='<?php if ($_SESSION['maquyen'] == 2) {echo "";} else {echo "?page=sua_nhan_vien&sua_nhan_vien=".$row->MaTK;}?>' ><i class="fa fa-edit"></i></a>
