        ...
        <div class="row ">
            <div class="col-lg-4 col-md-6 col-12 mb-3">
                <div class="d-flex align-items-center mb-4">
                    <img src="images/logo2.png" class="img-fluid logo-image">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-12 d-flex align-items-center">
                    <p class="copyright-text">Copyright © VT-APARTMENT 2024</p>
                </div>
                ...
                <div class="col-lg-3 col-12 mt-2 d-flex align-items-center mt-lg-0">
                    <p>DEVELOP BY: <a class="sponsored-link" rel="sponsored" href="https://www.tooplate.com" target="_blank">AK COMPANY</a></p>
                </div>
